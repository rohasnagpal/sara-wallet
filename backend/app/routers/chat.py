...
def _handle_tool_call(tool_name: str, args: dict, db: Session) -> str:
    ...
    if tool_name == "show_help":
        ...
        return (
            ...
            "**Tokens & Safety**\n"
            "• **Tokens** — deploy your own ERC-20 from tested templates, mint/burn/transfer, airdrop, plus Treasury, Intelligence, Risk and x402 sub-tabs\n"
            "• **Safety** — review and revoke token allowances, screen addresses for sanctions\n\n"
